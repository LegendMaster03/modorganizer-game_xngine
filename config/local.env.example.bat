...
set "BUILD_DIR_DEV="
set "MO2_UIBASE_PATH_ARCHIVE="
set "MO2_UIBASE_LIB_ARCHIVE="
set "MO2_SRC_PATH_ARCHIVE="
set "MO2_PLUGINS_DIR_ARCHIVE="
set "MO2_INSTALL_DIR_ARCHIVE="
set "BUILD_DIR_ARCHIVE="
set "QT_ROOT_RETAIL="
set "QT_ROOT_DEV="
set "QT_ROOT_ARCHIVE="
set "VCPKG_ROOT="
