#include "xnginebsainvalidation.h"
...
XngineBSAInvalidation::XngineBSAInvalidation(MOBase::DataArchives* dataArchives,
                       const QString& iniFilename,
                       MOBase::IPluginGame const* game)
    : m_DataArchives(dataArchives), m_IniFileName(iniFilename), m_Game(game)
{}

bool XngineBSAInvalidation::isInvalidationBSA(const QString& bsaName)
{
...
void XngineBSAInvalidation::deactivate(MOBase::IProfile* profile)
{
  prepareProfile(profile);
}

void XngineBSAInvalidation::activate(MOBase::IProfile* profile)
{
  prepareProfile(profile);
}

bool XngineBSAInvalidation::prepareProfile(MOBase::IProfile* profile)
{
  bool dirty          = false;
