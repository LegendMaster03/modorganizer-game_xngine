#ifndef XNGINEBSAINVALIDATION_H
#define XNGINEBSAINVALIDATION_H
...
class XngineBSAInvalidation : public MOBase::BSAInvalidation
{
public:
  XngineBSAInvalidation(MOBase::DataArchives* dataArchives,
